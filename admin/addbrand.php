                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="brand_name" id="validationCustom01">
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="brand_address" id="validationCustom01">
                            </div>
                            </div>
                            <div class="col-md-4">
                                <label for="validationCustom04" class="form-label">Brand Image</label>
