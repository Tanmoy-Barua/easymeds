            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
	                    ...
	                    <td>
                        <?php if($row['need_prescription']==0){echo 'No need';}elseif($row['need_prescription']==1){echo 'need prescription';}elseif($row['need_prescription']==3){echo 'Prescription Given';}  elseif($row['need_prescription']==4){echo 'Approve';}?>
                            <a class="btn btn-info btn-xs" href="prescriptionneed.php?id=<?php echo $row['id']; ?>&task=1" data-toggle="" data-target="" style="width:100%;">Give Prescription</a><br><br>
                            ...
                            <a class="btn btn-success btn-xs" href="prescriptionneed.php?id=<?php echo $row['id']; ?>&task=4" data-toggle="" data-target="" style="width:100%;">Approve</a>
	                    </td>
	                </tr>
