		                	...
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
                                    ...
                                    <form action="payment/bank/init.php" method="post" id="bank_form">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <label for=""><?php echo LANG_VALUE_44; ?> <br><span style="font-size:12px;font-weight:normal;">(<?php echo LANG_VALUE_45; ?>), If Bkash Payemnt Give your Bkash number & Trnsaction ID</span></label>
